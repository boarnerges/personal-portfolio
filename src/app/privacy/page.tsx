  ...
  return (
    <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 pt-24 sm:pt-32 pb-24">
      <div className="space-y-2 mb-12">
        <Link href="/" className="text-sm text-brand-warm hover:underline">&larr; Back</Link>
      ...
      <div className="space-y-6 text-sm leading-relaxed text-slate-600 dark:text-slate-400">
        ...
        <p>For questions about this policy or to request data deletion, contact: <a href="mailto:olujawo1996@gmail.com" className="text-brand-warm hover:underline">olujawo1996@gmail.com</a></p>
