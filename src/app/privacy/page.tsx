  ...
  return (
    <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 pt-24 sm:pt-32 pb-24">
      ...
      <div className="space-y-6 text-sm leading-relaxed text-slate-400">
        ...
        <h2 className="text-lg font-bold font-heading text-white">Information I Collect</h2>
        ...
        <h2 className="text-lg font-bold font-heading text-white">How I Use Your Information</h2>
        ...
        <h2 className="text-lg font-bold font-heading text-white">Data Storage</h2>
        ...
        <h2 className="text-lg font-bold font-heading text-white">Cookies</h2>
        ...
        <h2 className="text-lg font-bold font-heading text-white">Third-Party Services</h2>
        ...
        <h2 className="text-lg font-bold font-heading text-white">Contact</h2>
        ...
        <p className="text-xs text-slate-500 pt-6">Last updated: June 2026</p>
      </div>
    </div>
  );
}
