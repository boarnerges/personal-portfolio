...
const slides = [
  <React.Fragment key="1">
    <div className="text-center">
      <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold font-heading tracking-tight leading-[1.15] mb-6">
        More enquiries. Faster follow-ups.{" "}
        <span className="text-brand-blue">Less admin.</span>
      </h1>
    </div>
  </React.Fragment>,
  <React.Fragment key="2">
    <div className="text-center">
      <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold font-heading tracking-tight leading-[1.15] mb-6">
        Stop relying on{" "}
        <span className="text-brand-blue">referrals alone</span>.
      </h1>
  ...
  <React.Fragment key="3">
    <div className="text-center">
      <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold font-heading tracking-tight leading-[1.15] mb-6">
        ...
        <span className="text-brand-blue">DMs and spreadsheets</span>.
      </h1>
      <p className="text-base sm:text-lg max-w-2xl mx-auto text-slate-500 dark:text-slate-400 leading-relaxed">
