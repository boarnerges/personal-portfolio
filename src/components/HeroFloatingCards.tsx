            ...
            >
              <div
                ...
                className={`rounded-xl shadow-xl border backdrop-blur-md overflow-hidden transition-all duration-300 ${
                  isOpen ? "ring-2 ring-brand-blue/30 shadow-2xl scale-[1.02]" : "hover:shadow-2xl hover:scale-[1.01]"
                }`}
                style={{
                ...
                <div className="flex items-center justify-between p-3.5">
                  <div className="flex items-center space-x-2">
                    <div className={`h-2 w-2 rounded-full ${card.dot} ${
                      card.color === "emerald" ? "bg-emerald-500" : card.color === "amber" ? "bg-amber-500" : "bg-brand-blue"
                    }`} />
                    <span className={`text-xs font-semibold ${
                      card.color === "emerald" ? "text-emerald-600" : card.color === "amber" ? "text-amber-600" : "text-brand-blue"
                    }`}>{card.title}</span>
                  </div>
                  <div className="flex items-center space-x-2">
